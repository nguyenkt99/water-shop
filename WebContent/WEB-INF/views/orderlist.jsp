		...
		<div class="container">
			<div class="row mt-5">
				<div class="col-md-12">
					<br>
					<br>
					<p class="h4 font-weight-bold">Danh sách đơn hàng đã đặt</p>
				</div>
				<div class="col-md-12">
		            <table class="table">
		              ...
		              <c:forEach var="co" items="${ordercustomers}">
		                <tr>
		                  ...
		                  <td><a href="${pageContext.request.contextPath}/orderdetail/${co.id}.htm" class="btn btn-primary btn-sm">Xem chi tiết</a></td>
		                </tr>
		              </c:forEach>
		              </tbody>
		            </table>
